...
This is an ALX collaboration project on Shell between Nnadozie Kelechi and Okubo Vivien.
...
Description: Nnadozie Kelechi and Okubo Vivien Shell is a simple UNIX command interpreter that replicates functionalities of the simple shell (sh). Additional functions are also included. This program was written entirely in C as a milestone project for ALX Africa Software Engineering.
...
All code written by Nnadozie Kelechi and Okubo Vivien.

Authors 👤 TecIvy 👤 KayorKaly

TecIvy & KayorKaly @ ALX software engineering programme 2022.
